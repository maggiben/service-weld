...
| NFR-10 | Maintainability | Modular services, documented API, seedable reference data. Code MUST follow **SOLID** and **DRY**: single-responsibility modules, narrow contracts, domain/schemas as the shared source of truth (not copy-pasted UI/controller logic). See `docs/DEVELOPMENT.md` § Engineering principles.         |
