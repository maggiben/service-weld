...
Provide accurate, performant reporting and role-aware dashboards over cylinder circulation, float/aging, rental revenue, losses, supplier returns, medical consumption, and data quality — with drill-down to source events.
...
- `003` (indexes: partial open-movement + composite date indexes), `004` (endpoints), `009` (rate/rental logic), `011` (migration_exception feed), `005` (scoping).
